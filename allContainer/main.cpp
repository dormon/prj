...
int main(){
  AllContainer c;
  c.addValue<int>(10);
  c.addValue<float>(23.3f);
  c.addValue<std::shared_ptr<int32_t>>(new int32_t(3232));
  std::cout<<*c.getValue<float>(0)<<std::endl;
  std::cout<<**c.getValue<std::shared_ptr<int32_t>>(0)<<std::endl;
  return 0;
}
