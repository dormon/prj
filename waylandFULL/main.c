...
redraw(void *data, struct wl_callback *callback, uint32_t time)
{
  ...
  typedef void(*GG)(GLenum);
  typedef void(*GGG)(GLfloat,GLfloat,GLfloat,GLfloat);
  ((GGG)eglGetProcAddress("glClearColor"))(1,1,1,1);
  ((GG)eglGetProcAddress("glClear"))(GL_COLOR_BUFFER_BIT);
