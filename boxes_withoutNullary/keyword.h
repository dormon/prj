...
template<typename T,typename std::enable_if<std::is_class<T>::value && std::is_reference<T>::value,unsigned>::type = 0>
std::string keyword();
...
std::string keyword(){
  return keyword<typename MemFceClassType<T>::type>()+"::("+printArgs(typename MemFceArgType<T>::type())+")->"+keyword<typename MemFceReturnType<T>::type>();
}
...
template<typename T,typename std::enable_if<std::is_class<T>::value && std::is_const<T>::value,unsigned>::type>
inline std::string keyword(){return keyword<typename std::remove_const<T>::type>();}//+" const";}

template<typename T,typename std::enable_if<std::is_class<T>::value && std::is_reference<T>::value,unsigned>::type>
