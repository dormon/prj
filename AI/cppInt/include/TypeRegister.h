...
class Type{
  public:
    ...
    Type(
        TypeId   const&i,
        TypeType const&t,
        size_t   const&s):id(i),type(t),size(s){}
...
class VoidType  :public Type{public: VoidType  (TypeId const&i):Type(i,VOID  ,0                  ){}};
class I8Type    :public Type{public: I8Type    (TypeId const&i):Type(i,I8    ,sizeof(int8_t     )){}};
class I16Type   :public Type{public: I16Type   (TypeId const&i):Type(i,I16   ,sizeof(int16_t    )){}};
class I32Type   :public Type{public: I32Type   (TypeId const&i):Type(i,I32   ,sizeof(int32_t    )){}};
class I64Type   :public Type{public: I64Type   (TypeId const&i):Type(i,I64   ,sizeof(int64_t    )){}};
class U8Type    :public Type{public: U8Type    (TypeId const&i):Type(i,U8    ,sizeof(uint8_t    )){}};
class U16Type   :public Type{public: U16Type   (TypeId const&i):Type(i,U16   ,sizeof(uint16_t   )){}};
class U32Type   :public Type{public: U32Type   (TypeId const&i):Type(i,U32   ,sizeof(uint32_t   )){}};
class U64Type   :public Type{public: U64Type   (TypeId const&i):Type(i,U64   ,sizeof(uint64_t   )){}};
class F32Type   :public Type{public: F32Type   (TypeId const&i):Type(i,F32   ,sizeof(float      )){}};
class F64Type   :public Type{public: F64Type   (TypeId const&i):Type(i,F64   ,sizeof(double     )){}};
class StringType:public Type{public: StringType(TypeId const&i):Type(i,STRING,sizeof(std::string)){}};
