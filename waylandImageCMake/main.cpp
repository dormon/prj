...
int main(void)
{
  ...
  ___;
  auto compositor   = registry.getCompositor();
  ___;
  auto shell        = registry.getShell();
  ___;
  auto surface      = compositor.getSurface();
  ___;
  auto shellSurface = wayland::ShellSurface(shell,surface);
