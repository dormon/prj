...
class Window{
  public:
    typedef void(*EVENTPROC)(ge::core::Accessor const&data);
  ...
  public:
    ...
    void callCallback(std::string proc,ge::core::Accessor const&data);
    virtual void makeCurrent()const=0;
    virtual void swap()const=0;
};

class EventProc: public ge::core::Command{
  protected:
    std::map<std::string,std::shared_ptr<Window>>_windows;
    bool _pooling = true;
    bool _running = false;
    std::map<std::string,ge::core::TypeRegister::TypeID>_events;
  ...
  public:
    ...
    EventProc(std::shared_ptr<ge::core::TypeRegister>const&typeRegister,bool pooling = true);
    virtual ~EventProc();
