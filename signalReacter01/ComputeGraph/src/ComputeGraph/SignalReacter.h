...
template<typename SIGNAL_TYPE>
typename SignalReacter<SIGNAL_TYPE>::Neighbors const&SignalReacter<SIGNAL_TYPE>::getTargets()const{
  return signalNeighbors.at(TARGETS);
}

template<typename SIGNAL_TYPE>
typename SignalReacter<SIGNAL_TYPE>::Neighbors const&SignalReacter<SIGNAL_TYPE>::getSources()const{
  return signalNeighbors.at(SOURCES);
}


template<typename SIGNAL_TYPE>
void SignalReacter<SIGNAL_TYPE>::addNeighborOrIncrementCounter(Neighbors&neighbors,SignalReacter*r){
...
template<typename SIGNAL_TYPE>
void SignalReacter<SIGNAL_TYPE>::removeNeighborOrDecrementCounter(Neighbors&neighbors,SignalReacter*r){
  auto it = neighbors.find(r);
